  ...
  public: {
    Tables: {
      ...
      stack_share_links: {
        ...
        Insert: Partial<Database["public"]["Tables"]["stack_share_links"]["Row"]> & { stack_id: string; token: string };
      ...
      trusted_devices: {
        ...
        Insert: Partial<Database["public"]["Tables"]["trusted_devices"]["Row"]> & { user_id: string; device_id: string };
